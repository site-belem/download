...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Se o usuário clicar em "Baixar outro"
    if query.data == 'new_download':
        context.user_data.clear()
        await query.message.reply_text("Certo, mestre! Me envie o novo link que você deseja baixar.")
        return
    ...
    try:
        ...
        # --- BOTÃO PARA BAIXAR OUTRO ---
        keyboard = [[InlineKeyboardButton("🔄 Baixar outro arquivo", callback_data='new_download')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.message.reply_text("Download finalizado com sucesso! Deseja baixar mais alguma coisa?", reply_markup=reply_markup)
        # -------------------------------
